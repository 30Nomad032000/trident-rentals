                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className="flex justify-between text-sm text-gray-500 font-normal mb-2">
                            <span className="flex gap-[14px] items-center"><Image src="/space.svg" alt="space" height={100} width={100} className='size-5' />{space}</span>
                            <span className="flex gap-[14px] items-center"><Image src="/bed.svg" alt=" ed" height={100} width={100} className='size-5' /> {bedrooms}</span>
                            <span className="flex gap-[14px] items-center"><Image src="/bathroom.svg" alt=" ed" height={100} width={100} className='size-5' />{bathrooms}</span>
                        </div>
