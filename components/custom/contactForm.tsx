...
export const ContactForm = () => {
  return (
    <div className="container mx-auto p-10 bg-[url('/contactFormBg.svg')] bg-cover rounded-[20px] my-12">
          ...
          <div className="h-full ">
            <form className="h-full w-full bg-gray-100 rounded-[20px] bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-40 p-8 flex flex-col gap-5 items-center">
              <div className="w-full">
                ...
                <Input type="text" id="name" className="bg-white text-black" />
              </div>
              <div className="w-full">
              ...
              <div className="w-full">
                ...
                <Input type="tel" id="phone" className="bg-white text-black" />
              </div>
